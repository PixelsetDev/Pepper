...
$db->run("INSERT INTO recipes_reviews (`recipe_id`, `uuid`, `rating`, `comment`) VALUES (?, ?, ?, ?)", [$uriParts[3], $decoded->sub, $data->rating, $data->comment]);
echo new PepperResponse()->api(ResponseCode::Created(), json_encode(['status' => 'Review submitted']));